...
const Discuss = () => {
  ...
  useEffect(() => {
    const state = location.state as { fromDiscuss?: boolean };

    if (state?.fromDiscuss) {
      const savedDiscussions = sessionStorage.getItem("discussions");
      const savedLastVisible = sessionStorage.getItem("lastVisible");
      const savedScrollPosition = sessionStorage.getItem("scrollPosition");

      if (savedDiscussions) {
        setDiscussions(JSON.parse(savedDiscussions));
        setLastVisible(savedLastVisible ? JSON.parse(savedLastVisible) : null);
        setLoading(false);
